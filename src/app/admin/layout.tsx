...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex justify-between w-full h-[100vh] bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Modern Sidebar */}
      <div className={`${sidebarOpen ? 'w-[280px]' : 'w-[80px]'} h-[100vh] bg-white/80 backdrop-blur-xl border-r border-gray-200/50 shadow-2xl flex flex-col relative transition-all duration-300 ease-in-out`}>
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-blue-50/30 to-purple-50/20 pointer-events-none"></div>
        
        {/* Header */}
        <div className="relative w-full flex justify-between items-center p-6 border-b border-gray-200/60">
        ...
        {/* Navigation */}
        <div className="relative flex flex-col p-4 space-y-2 flex-1">
          {sidebarOpen && (
        ...
        {/* Modern User Profile */}
        <div className="relative p-4 border-t border-gray-200/60 bg-gradient-to-r from-white/50 to-gray-50/50">
      ...
      {/* Content Area */}
      <div className="flex-1 h-[100vh] p-6 overflow-auto">
