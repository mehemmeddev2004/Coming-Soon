...
const BagMenu: React.FC<BagMenuProps> = ({ onToggle, isOpen }) => {
  ...
  return (
    <div className="fixed inset-0 z-[50] flex">
      ...
      {/* Menu */}
      <div ref={menuRef} className="fixed right-0 top-0 w-full md:w-[600px] h-full bg-white p-4 md:p-6 flex flex-col">
        {/* Header */}
        ...
        <div className="mt-4">
          ...
          <div className="flex justify-between items-center mb-2">
            <div className="flex flex-col gap-y-[3px]">
              <span className="text-[9px] md:text-[10px] text-gray-600 font-[500] uppercase">Total</span>
          ...
          <button className="w-full h-[44px] md:h-[40px] bg-black text-white text-xs md:text-[12px] hover:bg-gray-800 transition-colors">
            CHECKOUT
          </button>
        </div>
      </div>
