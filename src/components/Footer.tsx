        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
            ...
            <div className="flex flex-col gap-5 lg:col-span-1">
              ...
              <div>
                <p className="text-slate-300 font-light leading-relaxed text-sm lg:text-base">
                  Crafting exceptional suits with Italian precision and artistry. Each piece is meticulously tailored to
                  perfection.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-slate-100 font-semibold text-lg tracking-wide uppercase text-sm">Contact Info</h4>
            ...
            {/* Follow Us */}
            <div className="flex flex-col gap-4">
              <h4 className="text-slate-100 font-semibold text-lg tracking-wide uppercase text-sm">Follow Us</h4>
              <ul className="flex flex-col gap-3">
                <li>
                  <Link
                    href="#"
            ...
            {/* Quick Links */}
            <div className="flex flex-col gap-4">
              <h4 className="text-slate-100 font-semibold text-lg tracking-wide uppercase text-sm">Quick Links</h4>
              <ul className="flex flex-col gap-3">
                <li>
          ...
          <div className="pt-8 border-t border-slate-800">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <p className="text-slate-400 text-sm text-center sm:text-left">
                © {new Date().getFullYear()} ETOR. All rights reserved.
              </p>
